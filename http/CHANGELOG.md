...
## [1.0.0-rc.2](https://github.com/trillium-rs/trillium/compare/trillium-http-v1.0.0-rc.1...trillium-http-v1.0.0-rc.2) - 2026-04-18

### Fixed

- *(deps)* update rust crate hashbrown to 0.17.0
- *(http)* small http3 correctness fixes and significant test coverage
