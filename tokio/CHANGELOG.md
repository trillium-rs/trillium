...
## [0.6.4](https://github.com/trillium-rs/trillium/compare/trillium-tokio-v0.6.3...trillium-tokio-v0.6.4) - 2026-06-19
...
- The connector now implements `Connector::connect_to` (new in `trillium-server-common`): given a
  `Destination` carrying pre-resolved socket addresses, it dials those directly instead of resolving
  the host.
