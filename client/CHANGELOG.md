...
## [0.7.0-rc.2](https://github.com/trillium-rs/trillium/compare/trillium-client-v0.7.0-rc.1...trillium-client-v0.7.0-rc.2) - 2026-04-18

### Added

- *(client)* add support for setting http version on the conn prior to exec

### Fixed

- *(client)* correctly set version to http/1.1 when falling back from a hinted http/3
