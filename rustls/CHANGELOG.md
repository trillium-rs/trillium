...
## [0.9.0](https://github.com/trillium-rs/trillium/releases/tag/trillium-rustls-v0.9.0) - 2026-01-21

### Added

- [**breaking**] release trillium-rustls 0.9.0

### Other

- *(rustls)* update rustls deps
