...
## [0.6.0](https://github.com/trillium-rs/trillium/compare/trillium-server-common-v0.5.2...trillium-server-common-v0.6.0) - 2026-04-08

### Added

- normalization pass
- small updates to the server header and announcement blog
